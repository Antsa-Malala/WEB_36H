...
<form class="text-center" method="post" action="<?php echo base_url("Page/verifie/"); ?>">
  <div class="mb-3">
    <input class="form-control" type="text" name="nom_utilisateur" placeholder="Entrer votre nom d'utilisateur">
  </div>
  <div class="mb-3">
    <input class="form-control" type="password" name="mot_de_passe" placeholder="Entrer votre Mot de Passe">
  </div>
  <div class="mb-3">
